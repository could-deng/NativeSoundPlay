...
void main(void){
	char * pFilename = "d:\\Temp\\DemoLog.dat";
	char * pJasonLog = "d:\\Temp\\jasonlog.txt";
	char * pJasonHR = "d:\\Temp\\jasonhr.txt";
	char * pJasonStep = "d:\\Temp\\jasonstep.txt";
	char * pJasonDistance = "d:\\Temp\\jasonDistance.txt";
	char * pJasonGPS = "d:\\Temp\\jasonGPS.txt";

#if 1
	converToLogJason(pFilename, pJasonLog);

	converToGPSJason("d:\\Temp\\GPS\\20170501062000.dat", 
						"d:\\Temp\\Distance\\20170501062000.dat",  
						pJasonGPS);

	converToStepJason("d:\\Temp\\GSensor\\20170501062000.dat", 
						"d:\\Temp\\Distance\\20170501062000.dat",  
						"d:\\Temp\\HeartRate\\20170501062000.dat", 
						pJasonStep);
#endif
